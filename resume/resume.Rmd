...
# Resume items
position_data <- read_csv('positions_sunny_ds_director.csv') %>% 
  filter(in_resume) %>% 
  mutate(
...
Proficient R Packages {#more-info}
--------------------------------------------------------------------------------

tidyverse | tidycensus | tidytext | ggplot2 | srvyr | haven | tigris | stringr | quanteda | rvest | shiny & and more
