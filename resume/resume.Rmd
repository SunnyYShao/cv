...
# Resume items
position_data <- read_csv('positions_sunny_survey_research.csv') %>% 
  filter(in_resume) %>% 
  mutate(
...
Proficient Open Source R Packages (shortlist) {#more-info}
--------------------------------------------------------------------------------

tidyverse | tidycensus | tigris | tidytext | ggplot2 | srvyr & haven | stringr | quanteda | rvest | shiny & and more
...
Selected Grants {data-icon=award}
--------------------------------------------------------------------------------
