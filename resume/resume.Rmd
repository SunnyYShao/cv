...
# Resume items
position_data <- read_csv('positions_sunny.csv') %>% 
  filter(in_resume) %>% 
  mutate(
...
![logo](all_projects.png){width=100%}
...
- <i class="fa fa-link"></i> [sunnyshao.come](https://sunnyshao.com/)
...
See full CV at [sunnyshao.com/cv](https://sunnyshao.com/cv) for more complete list of positions and publications.
