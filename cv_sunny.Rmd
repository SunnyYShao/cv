...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at sunnyshao.com/cv/_")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://www.sunnyshao.com/cv)")
}
```
...
The source code is available [on github.com/nstrayer/cv](https://github.com/sunnyyshao/cv).
